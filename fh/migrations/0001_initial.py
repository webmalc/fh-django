    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(related_name='sitetreeitem_parent', blank=True, to='fh.SiteTreeItem', help_text='Parent site tree item.', null=True, verbose_name='Parent')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='tree',
            field=models.ForeignKey(related_name='sitetreeitem_tree', verbose_name='Site Tree', to='fh.SiteTreeTree', help_text='Site tree this item belongs to.'),
        ),
